...
<div class="container py-5">
  <div class="payment-wrapper shadow-lg rounded-4 overflow-hidden">
    <div class="row g-0">
      ...
      {{-- ===== LEFT SIDE: SUMMARY ===== --}}
      <div class="col-lg-5 d-flex flex-column justify-content-between text-dark p-4"
           style="background: linear-gradient(160deg, PeachPuff, Cornsilk);">
        <div>
            ...
            @if($items->count())
              ...
              <ul class="mb-1 ps-3">
                @foreach($items as $item)
                  <li>{{ $item->name }} - ৳{{ number_format($item->price, 2) }}/month</li>
                @endforeach
              </ul>
            @endif
        ...
        <div class="text-center mt-3">
          <img src="{{ asset('assets/images/payment-illustration.png') }}" alt="Payment Illustration" 
      ...
      <div class="col-lg-7 p-5 text-center" style="background-color: Lavender;">
        ...
        {{-- Correct form for multiple items --}}
        ...
        <div class="mt-4">
          <small class="text-muted">
            <i class="fas fa-shield-alt me-1"></i> SSLCommerz ensures encrypted and secure transactions.
          </small>
        </div>
      </div>
